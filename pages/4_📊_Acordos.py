"""Página Acordos — consulta completa com filtros e abas por status."""
import sys
...
st.set_page_config(page_title="Acordos · LLE", page_icon="📊", layout="wide")
...
if st.session_state.get("acordo_id_aberto"):
    ...
    from src.telas.acordos import renderizar_acordos
    renderizar_acordos(usuario)
