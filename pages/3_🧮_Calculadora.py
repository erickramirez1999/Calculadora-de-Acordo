...
st.set_page_config(page_title="Calculadora · LLE", page_icon="🧮", layout="wide")
...
from src.telas.calculadora import renderizar_calculadora
renderizar_calculadora(usuario)
