"""Página Configurações - junta Parâmetros + Dashboard + Auditoria em abas."""
import sys
...
st.set_page_config(page_title="Configurações · LLE", page_icon="⚙", layout="wide")
...
from src.telas.admin_config import renderizar_admin_config
renderizar_admin_config(usuario)
